    ...
    <tbody>
        @foreach($estudiantes as $estudiante)
            <tr>
                ...
                <td style="text-align:center;">{{ $estudiante->marca->nombre }}</td>
                <td>{{ $estudiante->modelo }}</td>
                <td style="text-align:center;">{{$estudiante->nserie }}</td>
                <td style="text-align:center;">{{ $estudiante->id }}</td>
                <td style="text-align:center;">{{ $estudiante->institucion}}</td>
            </tr>
        @endforeach
    </tbody>
</table>
