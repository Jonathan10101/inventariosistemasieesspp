            ...
            <div class="angular-hero">
                <div>
                    ...
                    <p class="angular-subtitle">
                        Registra un usuario para que tenga acceso al sistema.
                    </p>
                </div>
            </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Escribe el nombre completo del usuario para registrar en el sistema.</p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="angular-field angular-floating @error('marca') has-error @enderror">
                                ...
                                <small class="angular-help">
                                    Ejemplo: JONATHAN MEDINA GARCIA, MARIA SALAZAR RODRIGUEZ.
                                </small>
