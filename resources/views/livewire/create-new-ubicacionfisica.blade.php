            ...
            <div class="angular-hero">
                <div>
                    ...
                    <p class="angular-subtitle">
                        Registra una ubicación física para asignar y localizar correctamente los bienes institucionales.
                    </p>
                </div>
            </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Escribe el nombre oficial del espacio físico donde pueden ubicarse los bienes.</p>
                        </div>
                    </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Sube una imagen opcional para identificar visualmente la ubicación física.</p>
                        </div>
                    </div>
