            ...
            <div class="angular-hero">
                <div>
                    <div class="angular-kicker">
                        ...
                        Nuevo resguardo institucional
                    </div>

                    <h4 class="angular-title">
                        Asignar nuevo resguardo
                    </h4>

                    <p class="angular-subtitle">
                        Registra la nueva ubicación, estado, responsable e imagen documental del bien institucional.
                    </p>
                </div>
            </div>
            ...
            <div class="angular-body">
                ...
                <div class="angular-alert mb-4">
                    ...
                    <div>
                        ...
                        <span>Los campos marcados con (*) son obligatorios. Puedes subir el PDF por clic o arrastrándolo desde el escritorio.</span>
                    </div>
                </div>

                {{-- CAMPOS OCULTOS DEL INVENTARIO --}}
                <input
                    type="hidden"
                    id="descripcionid"
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Sube una imagen clara del bien para documentar el nuevo resguardo.</p>
                        </div>
                    </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Define el estado del bien, el área de asignación y la ubicación física actual.</p>
                        </div>
                    </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Selecciona la persona responsable que recibirá el bien institucional.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="angular-field angular-select @error('puesto_id') has-error @enderror">
                                ...
                                <label for="puestodelresguardanteid" class="angular-field-label">
                                    Puesto del resguardante*
                                </label>

                                <select
                                    id="puestodelresguardanteid"
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Sube el archivo PDF firmado correspondiente al nuevo resguardo.</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <strong>Subir PDF del resguardo firmado</strong>
