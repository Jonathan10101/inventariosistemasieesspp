            ...
            <div class="angular-hero">
                <div>
                    ...
                    <p class="angular-subtitle">
                        Actualiza el nombre de la marca utilizada para clasificar los bienes del inventario institucional.
                    </p>
                </div>
            </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Modifica el nombre comercial de la marca registrada en el catálogo.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="angular-field angular-floating @error('marca') has-error @enderror">
                                <i class="fas fa-tag angular-field-icon"></i>
                                ...
                                <label for="marca" class="angular-field-label">
                                    Nombre de la marca*
                                </label>

                                <small class="angular-help">
                                    Ejemplo: DELL, HP, LENOVO, SAMSUNG, CANON.
                                </small>
