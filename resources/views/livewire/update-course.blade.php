    ...
    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="name" wire:model.defer="name_of_course" class="form-control" oninput="this.value = this.value.toUpperCase()">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number" id="hours" wire:model.defer="duration_of_course" class="form-control" oninput="this.value = this.value.toUpperCase()">
                            ...
                            @if($type_of_course == "programa")
                            <input type="radio" id="opcion_generacion" value="programa" 
                                wire:model="type_of_course" selected>
