            ...
            <div class="angular-hero">
                <div>
                    ...
                    <h4 class="angular-title">
                        Nueva área de asignación
                    </h4>

                    <p class="angular-subtitle">
                        Registra un área institucional para clasificar correctamente la asignación de bienes.
                    </p>
                </div>
            </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Escribe el nombre oficial del área donde podrán asignarse los bienes institucionales.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="angular-field angular-floating @error('area_de_uso') has-error @enderror">
                                <i class="fas fa-sitemap angular-field-icon"></i>

                                <input
                                    id="area_de_uso"
                                    type="text"
                                    wire:model.defer="area_de_uso"
                                ...
                                <label for="area_de_uso" class="angular-field-label">
                                    Nombre del área de asignación*
                                </label>

                                <small class="angular-help">
                                    Ejemplo: DIRECCIÓN GENERAL, INFORMÁTICA, RECURSOS MATERIALES, ALMACÉN.
                                </small>
