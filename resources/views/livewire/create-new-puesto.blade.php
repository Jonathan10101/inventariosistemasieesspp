            ...
            <div class="angular-hero">
                <div>
                    ...
                    <p class="angular-subtitle">
                        Registra un puesto institucional para asignarlo posteriormente a los resguardantes del inventario.
                    </p>
                </div>
            </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Escribe el nombre oficial del puesto que será usado en los resguardos institucionales.</p>
                        </div>
                    </div>
