            ...
            <div class="angular-hero">
                <div>
                    ...
                    <p class="angular-subtitle">
                        Actualiza los datos personales, puesto, correo y contraseña del responsable institucional.
                    </p>
                </div>
            </div>
            ...
            <div class="angular-body">
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            ...
                            <p>Actualiza el nombre completo del resguardante sin espacios al inicio.</p>
                        </div>
                    </div>
                ...
                <div class="angular-section mb-4">
                    <div class="angular-section-header">
                        ...
                        <div>
                            <h5>Puesto institucional</h5>
                            <p>Selecciona el cargo correspondiente del resguardante.</p>
                        </div>
                    </div>
