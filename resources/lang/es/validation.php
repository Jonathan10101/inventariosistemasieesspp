...
return [
    ...
    //Esta linea sirve para modificar los nombres de los campos y que se vea mejor
    'attributes' => array(
        'apellido1' => 'primer apellido',
        'nombre1' => 'primer nombre',
        'id_escolaridad' => 'escolaridad',
        'municipio_procedencia' => 'municipio de procedencia',
        'fecha_inicio_id' => 'fecha inicial',
        'fecha_final_id' => 'fecha final',
        'curso_id' => 'curso',
        'grupo_id' => 'grupo',
        'sede_id' => 'sede',
        'adscripcion_id' => 'adscripcion',
        'fecha_inicio_id' => 'fecha de inicio',
        'fecha_final_id' => 'fecha de terminación',
        'generacion_id' => 'generación',
        'estado_id' => 'estado',
        'municipio_de_procedencia' => 'municipio',
        'name_of_course' => 'nombre del curso',
        'duration_of_course' => 'duración del curso',
        'type_of_course' => 'tipo de curso',
        'fechaBaja' => 'fecha de baja',
        'motivoBaja' => 'motivo de baja',
        'fecha_validacion_id_inicial' => 'fecha de validación inicial',
        'fecha_validacion_id_final' => 'fecha de validación final',
        'fecha_ejecucion_id_inicial' => 'fecha de ejecución inicial',
        'fecha_ejecucion_id_final' => 'fecha de ejecución final'
