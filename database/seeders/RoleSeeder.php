...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $perm2->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm3 = Permission::create(['name'=>'inventario.edit']);
        $perm3->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        ...
        $perm6->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm7 = Permission::create(['name'=>'marcas.edit']);
        $perm7->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm8 = Permission::create(['name'=>'marcas.destroy']);
        $perm8->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        ...
        $perm10->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm11 = Permission::create(['name'=>'resguardante.edit']);
        $perm11->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        ...
        $perm14->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm15 = Permission::create(['name'=>'puestos.edit']);
        $perm15->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        ...
        $perm18->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm19 = Permission::create(['name'=>'ubicacionfisica.edit']);
        $perm19->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        ...
        $perm22->syncRoles([$role1,$role2,$role3,$role4,$role5]);
        $perm23 = Permission::create(['name'=>'areadeasignacion.edit']);
        $perm23->syncRoles([$role1,$role2,$role3,$role4,$role5]);
